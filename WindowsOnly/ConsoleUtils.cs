...
namespace CSharpUtilsAndExtensionMethods.WindowsOnly
{
    public static class ConsoleUtils
    {
        ...
        // Quick edit mode can freeze the console until a key is input, hence why it's good to disable it.
        public static void CheckAndDisableQuickEditMode()
        {
            if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
            {
                ...
                {
                    // If STDIN is redirected (e.g. in the case of SeriLog), then need to get console handle with CreateFile method
                ...
                {
                    Console.WriteLine("Quick Edit mode in the console is enabled. Disabling it to prevent freezing of WebApi.");
        ...
        // Recommended usage: minize console window on app startup
